...
<div class="flex w-full my-4">
    <!-- awal sidebar -->
    <div class="flex flex-col w-72 bg-primary rounded-r" id="sidebarSearch">
        <div class="flex px-4 py-1 justify-between bg-indigo-900">
            <div class="text-xl my-auto font-semibold text-secondary" id="param1"> FILTER</div>
            <svg class="w-8 fill-current text-secondary cursor-pointer" id="hamburgerSidebar" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
        </div>

        <div class="flex flex-col mt-4 " id="param2">
            <div class="text-secondary hover:bg-blue-800 hover:bg-opacity-75 font-medium px-4 py-1 cursor-pointer" id="filterSidebar">Semua</div>
            <div class=" text-white hover:bg-blue-800 hover:bg-opacity-75 font-medium px-4 py-1 cursor-pointer" id="filterSidebar">Alumni</div>
            <div class="flex flex-col py-1 px-7 w-full hidden" id="listFilterSidebarAlumni">
                <div class="flex justify-between mb-1">
                    <div class="text-sm text-white cursor-pointer"> jurusan</div>
                ...
                <div class="flex justify-between mb-1">
                    <div class="text-sm text-white cursor-pointer"> Angkatan</div>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex justify-between mb-1">
                    <div class="text-sm text-white cursor-pointer"> Tempat Kerja</div>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="text-white hover:bg-blue-800 hover:bg-opacity-75 font-medium px-4 py-1 cursor-pointer" id="filterSidebar">Artikel/Berita</div>
            <div class="flex flex-col py-1 px-7 w-full hidden" id="listFilterSidebarBerita">
                <div class="flex justify-between mb-1">
                    <div class="text-sm text-white cursor-pointer"> Rentang Waktu</div>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex justify-between mb-1">
                    <div class="text-sm text-white cursor-pointer"> Penulis</div>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                    <svg class="w-3 h-3 my-auto text-white font-semibold cursor-pointer hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class=" ml-2">
        <div class="flex md:flex-row flex-grow flex-col justify-around lg:px-20 md:px-8 px-2">
