...
<div class="w-60 fixed  z-10 h-10 bg-primary rounded-r">
    <div class="flex px-4 py-1 justify-between">
        <div class="text-2xl font-bold text-secondary"> FILTER</div>
        <svg class="w-8 fill-current text-secondary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
