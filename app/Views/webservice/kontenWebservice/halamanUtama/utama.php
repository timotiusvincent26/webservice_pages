...
<div class="sm:mt-32 mt-16 flex sm:static relative xl:mx-32 lg:mx-24 md:mx-16 sm:mx-10 mx-6" style="z-index: -10;" id="utama">
    ...
    <div class="sm:flex sm:flex-col sm:justify-center hidden w-3/12 relative">
