            ...
            <div class="flex flex-col py-1 px-6 w-full hidden" id="listFilterSidebarAlumni">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col mb-1 px-4 hidden" id="listTempatKerja">
                        ...
                        <input type="text" placeholder="BPS RI/Provinsi/kota" class="placeholder-gray-300 text-primary font-paragraph text-xs px-2 py-1 outline-none mb-2 focus:ring-2 focus:ring-secondary font-paragraph rounded-lg">
                        <!-- Awal Input Filter "Tempat Kerja BPS" Untuk Alumni  -->
                        ...
                        <input type="text" placeholder="Institusi/Perusahaan Lain" class="placeholder-gray-300 text-xs font-paragraph text-primary px-2 py-1 outline-none mb-1 focus:ring-2 focus:ring-secondary font-paragraph rounded-lg">
                        <!-- Awal Input Filter "Tempat Kerja Lainnya" Untuk Alumni  -->
