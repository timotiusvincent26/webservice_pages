            ...
            <div class="md:space-x-4 flex flex-row items-center justify-center lg:justify-start md:py-2 px-4 md:px-0">
                ...
                <div class="w-1/2">
                    ...
                    <div class="inline-block flex flex-row">
                        <img src="/img/icon/fb.png" alt="" class="float-left w-5 h-5">
                        <span class="font-heading text-xs text-primary text-center ml-2 md:ml-3">Khabib Nurma</span>
                    </div>
                </div>
                <div class="w-1/2 ml-2">
                    <!-- Twitter -->
                    <div class="inline-block mb-2 flex flex-row">
                        <img src="/img/icon/twit.png" alt="" class="float-left w-5">
                        <span class="font-heading text-xs text-primary text-center ml-1 md:ml-3">@khabibNMGDV</span>
                    </div>
                    <!-- Instagram -->
                    <div class="inline-block flex flex-row">
                        <img src="/img/icon/ig.png" alt="" class="float-left w-5">
                        <span class="font-heading text-xs text-primary text-center ml-1 md:ml-3">@IG_Khabib</span>
                    </div>
                </div>
            </div>
            <!--  Akhir media sosial-->
...
<div class="w-full my-8 lg:px-20 md:px-8 px-2">
    ...
    <div class="md:shadow-lg lg:shadow-xl rounded-2xl px-3 py-3 md:px-7 md:py-5 lg:mx-14 lg:py-8 lg:px-10 md:mt-3">
        <table class="table-auto font-heading">
            <tbody>
                <tr>
                    <td class="font-bold text-primary lg:pb-2">Instansi :</td>
                    <td class="pl-0 md:pl-6">Badan Pusat Statistik (BPS)</td>
                </tr>
                <tr>
                    <td class="font-bold text-primary lg:pb-2">Alamat : </td>
                    <td class="pl-1 md:pl-6">Jl. Otto Iskandardinata 64C, Jatinegara</td>
                </tr>
                <tr>
                    <td class="font-bold text-primary lg:pb-2">Telp : </td>
                    <td class="pl-2 md:pl-6">021 - 12002112</td>
                </tr>
                <tr>
                    <td class="font-bold text-primary lg:pb-2">Faks : </td>
                    <td class="pl-2 md:pl-6">1234 - 12345</td>
                </tr>
                <tr>
                    <td class="font-bold text-primary lg:pb-2">Email : </td>
                    <td class="pl-2 md:pl-6">bps@bps.go.id</td>
                </tr>
            </tbody>
        </table>
    </div>
...
<div class="w-full my-8 lg:px-20 md:px-8 px-2">
    ...
    <div class="md:shadow-lg lg:shadow-xl rounded-2xl px-0 py-1 md:px-5 md:py-5 lg:mx-14 lg:p-8 mb-1 md:mt-3">
        <?php for ($x = 0; $x < 3; $x++) : ?>
            <div class="flex justify-between px-3 font-heading text-primary mt-1 md:mt-2 lg:mt-3">
