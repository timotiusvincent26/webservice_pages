...
<div class="w-full bg-white min-h-screen">
    <table class="w-full text-sm">
        <thead class="formEdit">
            <tr>
                <th class="pt-3 px-3 pb-0 rounded-tl-3xl">No</th>
                <th class="pt-3 px-3 pb-0 text-left">Nama Prestasi</th>
                <th class="pt-3 pl-4 pr-0 pb-0">
                    <div class="flex">
                        <span>Tahun</span>
                ...
                <th class="pt-3 px-3 pb-0 rounded-tr-3xl">Aksi</th>
            </tr>
            <tr>
                <td></td>
                <td><input type="text" name="cariPrestasi" id="cariPrestasi" placeholder="Cari" class="ml-2 w-11/12 focus:outline-none focus:ring rounded-md px-2 text-gray-400 formEdit mb-2"></td>
                <td colspan="2"></td>
            </tr>
        </thead>
        <tbody>
            <tr class="border-t-2 border-b-2 bg-white">
                ...
                <td>
                    <div class="flex justify-center">
                        <div class="editPrestasi cursor-pointer mr-1"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
