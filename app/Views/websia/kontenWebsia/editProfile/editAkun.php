...
<div class="p-6 font-paragraph text-primary h-full">
    <div class="w-1/2">
        ...
        <div class="text-red-600 text-xs mb-2">Silakan masukkan password lama Anda untuk verifikasi.</div>
        <div class="font-medium mb-2">Password Lama:</div>
        <input type="password" name="passlama" id="passlama" class="w-full p-2 border-2 border-gray rounded-lg mb-96" placeholder="●●●●●●●●">
    </div>
