...
<div class="w-full bg-white min-h-screen md:overflow-x-auto overflow-x-scroll md:w-full" id="pagePublikasi">
    <table class="w-full sm:text-sm text-xs">
        ...
        <tbody>
            <tr class="border-t-2 border-b-2 bg-white">
                ...
                <td>Gramedia</td>
                <td>2003</td>
                <td>Pernah ada Rasa</td>
                <td>
                    <div class="flex justify-center">
                        <div class="editPublikasi cursor-pointer mr-1"><svg class="lg:w-5 lg:h-5 w-4 h-4" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="hapus cursor-pointer"><svg class="lg:w-5 lg:h-5 w-4 h-4" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
