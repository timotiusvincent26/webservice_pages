...
<div class="grid grid-cols-4 mt-4 gap-x-6">
    <div class="col-span-1 bg-primary">
        <div id="navEdit" class="mt-4">
            <ul>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold active">Biodata</li>
                </a>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold">Pendidikan</li>
                </a>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold">Tempat Kerja</li>
                </a>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold">Prestasi</li>
                </a>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold">Publikasi</li>
                </a>
                <a href="">
                    <li class="navbarEdit font-heading p-3 text-sm text-white hover:text-secondary hover:bg-primary text-center font-semibold">Akun</li>
                </a>
            </ul>
        </div>
    </div>
