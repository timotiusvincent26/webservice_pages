...
<div class="w-full bg-white min-h-screen">
    <table class="w-full text-sm">
        <thead class="formEdit">
            <tr>
                <th class="pt-4 px-5 pb-2 rounded-tl-3xl">No</th>
                <th class="pt-4 px-4 pb-2">Jenjang</th>
                <th class="pt-4 px-4 pb-2">Universitas</th>
                <th class="pt-4 px-4 pb-2">Program Studi</th>
                <th class="pt-4 pl-4 pr-0 pb-2">
                    <div class="flex">
                        <span>Tahun Masuk</span>
                        <div class="select-none ml-2 -mr-3 cursor-pointer flex flex-col justify-center sort">
                ...
                <th class="pt-4 pl-4 pr-0 pb-2 flex">
                ...
                <th class="pt-4 px-4 pb-2">Judul Tulisan</th>
                <th class="pt-4 px-4 pb-2 rounded-tr-3xl">Aksi</th>
            </tr>
            <tr>
                <td></td>
                <td class="text-sm">
                    <span>All</span>
                    <span class="select-none cursor-pointer mr-5 float-right sort">
                ...
                <td colspan="2"></td>
                <td><input type="text" name="cariTulisan" id="cariTulisan" placeholder="Cari" class="w-11/12 focus:outline-none focus:ring rounded-md w-full px-2 text-gray-400 formEdit mb-3"></td>
                <td></td>
            </tr>
        </thead>
        <tbody>
            <tr class="border-t-2 border-b-2 bg-white">
                ...
                <td>
                    <div class="flex justify-center">
                        <div class="editPendidikan cursor-pointer mr-1"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="hapus cursor-pointer"><svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
