...
<div class="w-full bg-white min-h-screen md:overflow-x-auto overflow-x-scroll md:w-full" id="pagePendidikan">
    <table class="w-full sm:text-sm text-xs">
        ...
        <tbody>
            ...
            <tr class="border-b-2 bg-white">
                ...
                <td>S2</td>
                <td>Intitus Tekonologi Bandung</td>
                <td>Teknik Tata Kelola Lingkungan dan Habitatnya</td>
                <td>2001</td>
                <td>2005</td>
                <td>Robotika</td>
                <td>
