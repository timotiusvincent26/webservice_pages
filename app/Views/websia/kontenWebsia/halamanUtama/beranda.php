...
<div class="w-full my-8 lg:px-20 md:px-8 px-3">
    ...
    <div class="flex flex-col items-center md:flex-row md:justify-around w-full mt-4">
        ...
        <div class="w-min mb-2 md:mb-0 py-6 px-6 bg-contain bg-no-repeat bg-left" style="background-image: url(/img/bulat.png)" data-aos="zoom-in">
            <div class="text-primary md:text-3xl lg:text-4xl text-xl font-bold md:mb-4 mb-2 font-heading">38.578</div>
            <div class="text-gray-500 text-xs font-semibold text-center font-paragraph">Lulusan AIS</div>
        </div>
        ...
        <div class="w-min mb-2 md:mb-0 py-6 px-6 bg-contain bg-no-repeat bg-left" style="background-image: url(/img/bulat.png)" data-aos="zoom-in">
            <div class="text-primary md:text-3xl lg:text-4xl text-xl font-bold md:mb-4 mb-2 font-heading">38.578</div>
            <div class="text-gray-500 text-xs font-semibold text-center font-paragraph">Lulusan STIS</div>
        </div>
        ...
        <div class="w-min mb-2 md:mb-0 py-6 px-6 bg-contain bg-no-repeat bg-left" style="background-image: url(/img/bulat.png)" data-aos="zoom-in">
            <div class="text-primary md:text-3xl lg:text-4xl text-xl font-bold md:mb-4 mb-2 font-heading">38.578</div>
            <div class="text-gray-500 text-xs font-semibold text-center font-paragraph">Lulusan Polstat STIS</div>
        </div>
